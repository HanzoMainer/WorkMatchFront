...
const SpecialistModalForm = ({ specialistData, setSpecialistData, onSubmit, error, success, onCancel }) => {
  return (
    <Box className={styles.modalBox}>
      ...
      <form onSubmit={onSubmit}>
        <TextField
          ...
          onChange={(e) => setSpecialistData({ ...specialistData, position: e.target.value })}
          fullWidth
          margin="normal"
          required
        />
        <TextField
          ...
          onChange={(e) => setSpecialistData({ ...specialistData, about_me: e.target.value })}
          fullWidth
          margin="normal"
          multiline
          rows={4}
        ...
        <FormControl fullWidth margin="normal">
          ...
          <Select
            ...
            label="Тип занятости"
            onChange={(e) => setSpecialistData({ ...specialistData, employment_type_str: e.target.value })}
            required
          >
